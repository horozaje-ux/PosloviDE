...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // =========================
  // 2. SUBMIT FORME (fake slanje)
  // =========================

  function handleFakeSubmit(formId, msgId) {
